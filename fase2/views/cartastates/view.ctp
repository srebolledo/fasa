<div class="cartastates view">
<h2><?php  __('Cartastate');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $cartastate['Cartastate']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Nombre'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $cartastate['Cartastate']['nombre']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Cartastate', true), array('action' => 'edit', $cartastate['Cartastate']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Cartastate', true), array('action' => 'delete', $cartastate['Cartastate']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $cartastate['Cartastate']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($cartastate['Onereport'])):?>
	...
	<?php
		$i = 0;
		foreach ($cartastate['Onereport'] as $onereport):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
