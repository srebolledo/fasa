...
<div class="emsefors index">
	...
	<tr<?php echo $class;?>  onclick="window.location.assign('<?php echo $view_url; ?>');">
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $emsefor['Emsefor']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $emsefor['Emsefor']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
