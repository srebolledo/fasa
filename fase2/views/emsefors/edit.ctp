...
<?php echo $this->Form->create('Emsefor');?>
	<fieldset>
 		<legend><?php __('Edit Emsefor'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('nombre');
		echo $this->Form->input('lugar',array('label'=>'SAP'));
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Emsefor.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Emsefor.id'))); ?></li>
