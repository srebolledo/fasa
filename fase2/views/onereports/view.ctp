	...
	<div id="box">
		<div id="leftside">
			<label>Ingeniero: </label>
				<?php echo $this->requestAction("/engineers/getName/".$onereport['Onereport']['engineer_id']); ?>
			<label>Folio:</label>
			...
			<label>Código SAP:</label>
				<?php echo $onereport['Onereport']['sap']; ?>																		
			<label>Cargo:</label>
		...
		<label>Indicador:</label>
			...
			<label>Fecha de inicio del proyecto:</label>
				<?php echo $onereport['Onereport']['proyectofecha']; ?>
			<label>Fecha de finalización del proyecto:</label>
				<?php echo $onereport['Onereport']['proyectofechafin']; ?>
