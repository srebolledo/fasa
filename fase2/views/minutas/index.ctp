<div class="minutas index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('participantes');?></th>
			<th><?php echo $this->Paginator->sort('temas_a_tratar');?></th>
			<th><?php echo $this->Paginator->sort('acuerdos');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $minuta['Minuta']['participantes']; ?>&nbsp;</td>
		<td><?php echo $minuta['Minuta']['temas_a_tratar']; ?>&nbsp;</td>
		<td><?php echo $minuta['Minuta']['acuerdos']; ?>&nbsp;</td>
		<td class="actions">
