...
<div class="tworeports form">
	...
	<div id="box">
		<div id="leftside">
		<?php
			echo $this->Form->input('participantes_reales',array('label'=>'Número de participantes reales'));
			echo $this->Form->hidden('participantes');
			echo $this->Form->hidden('id');
			echo $this->Form->hidden('engineer_id');
			echo $this->Form->hidden('semana');
			echo $this->Form->hidden('fecha');
			echo $this->Form->hidden('activity_id',array('label'=>'Actividad'));
			echo $this->Form->hidden('cuadrilla',array('type'=>'text'));
			echo $this->Form->hidden('unity_id',array('label'=>'Unidad'));
			echo $this->Form->hidden('contacto');
			echo $this->Form->hidden('save',array('value'=>'true'));
	?>
	...
	<input type="text" id="search" /></div>-->
		<?php	
			...
			echo $this->Form->hidden('place_id',array('label'=>'Lugar de la reunión'));
			echo $this->Form->hidden('state_id',array('label'=>'Estado'));
			echo $this->Form->hidden('tema',array('label'=>'Temas a tratar'));
