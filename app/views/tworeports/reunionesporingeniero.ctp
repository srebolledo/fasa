...
$b2plot = new BarPlot($data[3]);
$b3plot = new BarPlot($data[4]);
$b4plot = new BarPlot($data[1]);
$b5plot = new BarPlot($data[5]);
$b6plot = new BarPlot($data[6]);
...
$graph->title->Set("Reuniones por ingeniero efectivamente realizadas");

// Display the graph
$graph->Stroke(getcwd()."/tmp/reunionesporingeniero.png");
$graph->Stroke();
