...
<?php echo $this->Form->create('Engineer');?>
	<fieldset>
 		<legend><?php __('Edit Engineer'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Engineer.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Engineer.id'))); ?></li>
