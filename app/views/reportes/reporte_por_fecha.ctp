...
Highcharts.setOptions( chartOptions );
		...
		$("#ReporteStartDate").datepicker({dateFormat: 'yy-mm-dd'});
		$("#ReporteEndDate").datepicker({dateFormat: 'yy-mm-dd'});
	...
	<div class="index">
		<?php 
			...
			echo $this->Form->input('end_date',array('label'=>"Fecha de término"));
			echo $this->Form->end('Enviar',	true);
