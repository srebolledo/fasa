<div class="proyectostates view">
<h2><?php  __('Proyectostate');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $proyectostate['Proyectostate']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Nombre'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $proyectostate['Proyectostate']['nombre']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Proyectostate', true), array('action' => 'edit', $proyectostate['Proyectostate']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Proyectostate', true), array('action' => 'delete', $proyectostate['Proyectostate']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $proyectostate['Proyectostate']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($proyectostate['Onereport'])):?>
	...
	<?php
		$i = 0;
		foreach ($proyectostate['Onereport'] as $onereport):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
