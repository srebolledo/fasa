...
<!--		<th><?php echo $this->Paginator->sort('trabajador');?></th>-->
			...
			<th><?php echo $this->Paginator->sort('Estado de idea','ideasstate_id');?></th>
			<th><?php echo $this->Paginator->sort('Estado de carta','cartastate_id');?></th>
			<th><?php echo $this->Paginator->sort('Estado de proyecto','proyectostate_id');?></th>
...
<!--			<th><?php echo 'Fecha de término';?></th>-->
	...
	<tr<?php echo $class;?> onclick="window.location.assign('<?php echo $view_url; ?>');">
		<td><?php echo $j;$j++;?></td>
		<td><?php echo $onereport['Onereport']['id'];?></td>
...
<!--		<td><?php if(strtotime($onereport['Onereport']['proyectofecha']) > 0) echo $onereport['Onereport']['proyectofecha'];
		...
		<?php
			...
			echo $this->Html->link(__('Editar', true), array('action' => 'edit', $onereport['Onereport']['id']))."<br><br>";

			if($usuario['group_id'] == 2){
				echo $this->Html->link(__('Editar', true), array('action' => 'edit', $onereport['Onereport']['id']));
				echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $onereport['Onereport']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $onereport['Onereport']['id']));
			}	
			else{
				echo $this->Html->link(__('Ver', true), array('action' => 'view', $onereport['Onereport']['id']));
			}
		?>
